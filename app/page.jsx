    ...
    <div className="bg-[#030604] min-h-screen text-white font-sans selection:bg-[#D4AF37] selection:text-black">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-2xl bg-[#030604]/90 border-b border-[#D4AF37]/30 px-4 md:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => switchTab('properties-tab')}>
          ...
          <span className="cinzel-font text-xl md:text-2xl tracking-widest gold-metallic-text font-extrabold">PD INDIRAPURAM</span>
        </div>
        <div className="flex items-center gap-2">
          <button onClick={() => switchTab('properties-tab')} className="gold-metallic-bg text-black px-4 py-2 rounded-xl font-extrabold text-xs uppercase shadow-[0_0_20px_rgba(212,175,55,0.4)] transition hover:scale-105">
            Explore Assets 👑
          </button>
        </div>
      </nav>
        ...
        <>
          ...
          <section className="py-12 px-4 max-w-4xl mx-auto text-center">
            <div className="futuristic-card rounded-3xl p-6 md:p-10 border border-[#D4AF37]">
              ...
              <h2 className="cinzel-font text-2xl md:text-3xl text-white font-bold mt-1 mb-2">Book Private Site Visit</h2>
          ...
          <section className="py-16 px-4 max-w-6xl mx-auto border-t border-[#D4AF37]/20 mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Phone Channel */}
              <a href="tel:09990345444" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-[#D4AF37] hover:scale-105 transition group">
                <div className="w-12 h-12 rounded-xl bg-[#D4AF37]/20 border border-[#D4AF37] flex items-center justify-center text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-black transition">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                </div>
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">Official Phone Desk</span>
                  <span className="text-sm font-bold text-white group-hover:text-[#D4AF37] transition">+91 99903 45444</span>
                </div>
              </a>

              {/* WhatsApp Channel */}
              <a href="https://wa.me/919990345444?text=Greetings!%20I%20am%20interested%20in%20a%20VIP%20Property%20Consultation." target="_blank" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-[#25D366] hover:scale-105 transition group">
                <div className="w-12 h-12 rounded-xl bg-[#25D366]/20 border border-[#25D366] flex items-center justify-center text-[#25D366] group-hover:bg-[#25D366] group-hover:text-white transition">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981z"/></svg>
                </div>
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">WhatsApp VIP Chat</span>
                  <span className="text-sm font-bold text-white group-hover:text-[#25D366] transition">Chat On WhatsApp</span>
                </div>
              </a>

              {/* Email Channel */}
              <a href="mailto:contact@pdindirapuram.com" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-blue-400 hover:scale-105 transition group">
                <div className="w-12 h-12 rounded-xl bg-blue-500/20 border border-blue-400 flex items-center justify-center text-blue-400 group-hover:bg-blue-500 group-hover:text-white transition">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">Official Email</span>
                  <span className="text-sm font-bold text-white group-hover:text-blue-400 transition">contact@pdindirapuram.com</span>
                </div>
              </a>

              {/* Instagram Channel */}
              <a href="https://instagram.com/pd_indirapuram_property_dealer" target="_blank" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-pink-500 hover:scale-105 transition group">
                <div className="w-12 h-12 rounded-xl bg-pink-500/20 border border-pink-500 flex items-center justify-center text-pink-500 group-hover:bg-pink-500 group-hover:text-white transition">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">Instagram</span>
                  <span className="text-sm font-bold text-white group-hover:text-pink-500 transition">@pd_indirapuram...</span>
                </div>
              </a>

              {/* LinkedIn Channel */}
              <a href="https://linkedin.com" target="_blank" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-sky-500 hover:scale-105 transition group">
                <div className="w-12 h-12 rounded-xl bg-sky-500/20 border border-sky-500 flex items-center justify-center text-sky-500 group-hover:bg-sky-500 group-hover:text-white transition">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </div>
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">LinkedIn Business</span>
                  <span className="text-sm font-bold text-white group-hover:text-sky-500 transition">PD Indirapuram</span>
                </div>
              </a>
              ...
              <a href="https://x.com" target="_blank" className="futuristic-card p-5 rounded-2xl flex items-center gap-4 hover:border-white hover:scale-105 transition group">
                ...
                <div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider block">X Platform (Twitter)</span>
                  <span className="text-sm font-bold text-white transition">@PD_Indirapuram</span>
                </div>
              </a>
            </div>
          </section>
